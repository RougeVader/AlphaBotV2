...
const STATIC_FLUFF = ['is', 'are', 'were', 'am', 'be', 'been', 'being', 'do', 'does', 'did', 'have', 'has', 'had', 'can', 'could', 'will', 'would', 'should', 'who', 'whose', 'whom', 'where', 'when', 'why', 'how', 'the', 'of', 'for', 'a', 'an', 'please', 'kindly', 'select', 'to', 'than', 'at', 'with', 'region', 'department', 'dept', 'give', 'me', 'tell', 'us', 'get', 'site', 'stations', 'project', 'projects', 'metrics', 'data', 'information', 'was', 'from', 'between', 'and', 'tracker', 'unit', 'id', 'details', 'everything', 'all', 'info', 'having', 'days', 'months', 'years', 'day', 'month', 'year'];
